...
tree_file <- "/home/jaman_umass_edu/jaman/Myo2_phylogeny/results/sup_figure_run_3/tree_inference_result/sup_figure_run_3_input4_aligned.fasta.contree"
